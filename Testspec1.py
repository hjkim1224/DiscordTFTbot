...
API_KEY = "RGAPI-b37b8cf9-4576-42be-80c9-920a0c2feac3" #API 24시간마다초기화잊지않기기
PLAYER_NAME = "현실회피장치"
PLAYER_TAG = "LOL"
...
def analyze_lobby_decks(current_game_info, my_puuid): # 로비 이전 덱 분석
    ...
    for trait_name, count in top_placer_traits.most_common(3): #상위3개
        advice_message += f"> **{trait_name}**: {count}명 사용\n"
    advice_message += "*겹칠 확률이 높은 덱입니다. 해당 덱 지양을 추천합니다.*"
